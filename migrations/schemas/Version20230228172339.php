 ...
 */
final class Version20230228172339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dumpling_requirement (id INT AUTO_INCREMENT NOT NULL, form_id INT NOT NULL, dumpling_id INT NOT NULL, form_validator_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, INDEX IDX_38124E205FF69B7D (form_id), INDEX IDX_38124E20E0888F5E (dumpling_id), INDEX IDX_38124E20DA23018E (form_validator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
